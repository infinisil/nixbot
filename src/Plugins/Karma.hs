...
increaseMessages =
  ...
  , (10000000, ((== 419), \_ chan nick increase -> increase *> chanMsg chan "( *∀*)y─┛   420 blaze it" *> chanMsg chan (nick <> "'s karma ^^")))
  , (10000000, ((== 403), \_ chan nick increase -> increase *> chanMsg chan "404 Karma not found"))
  ] where
